...
def test_branch_type_accepts_pvr_repair_medium() -> None:
    cfg = AppConfig.model_validate(
        {
            "project": {"name": "dc", "seed": 1, "run_tag": "t"},
            "paths": {"data_root": "data", "output_root": "outputs", "prompt_dir": "configs/prompts"},
    ...
    assert cfg.experiment.branches[0].branch_type == "pvr_repair_medium"


def test_branch_type_accepts_dbr_medium() -> None:
    cfg = AppConfig.model_validate(
        {
            "project": {"name": "dc", "seed": 1, "run_tag": "t"},
            "paths": {"data_root": "data", "output_root": "outputs", "prompt_dir": "configs/prompts"},
    ...
    assert cfg.experiment.branches[0].branch_type == "dbr_medium"


def test_branch_type_accepts_pair_lite_medium() -> None:
    cfg = AppConfig.model_validate(
        {
            "project": {"name": "dc", "seed": 1, "run_tag": "t"},
            "paths": {"data_root": "data", "output_root": "outputs", "prompt_dir": "configs/prompts"},
    ...
    assert cfg.experiment.branches[0].branch_type == "pair_lite_medium"


def test_branch_type_accepts_csr_medium() -> None:
    cfg = AppConfig.model_validate(
        {
            "project": {"name": "dc", "seed": 1, "run_tag": "t"},
            "paths": {"data_root": "data", "output_root": "outputs", "prompt_dir": "configs/prompts"},
    ...
    assert cfg.experiment.branches[0].branch_type == "csr_medium"
